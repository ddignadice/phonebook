...
class UserAccount extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('username, email, password', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('user_account_id, username, email, password', 'safe', 'on'=>'search'),
		);
	}
	...
	public function insertUserAccount($column)
	{
		$cmd = Yii::app()->db->createCommand();
		$cmd->insert('user_account', array(
